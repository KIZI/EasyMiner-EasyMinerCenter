...
--
-- Počítač: localhost
-- Vygenerováno: Úte 24. lis 2015, 00:14
-- Verze MySQL: 5.5.46
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='Tabulka obsahující informaci o namapování datových sloupců na formáty z KB' AUTO_INCREMENT=748 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='Tabulka obsahující jednotlivé cedenty' AUTO_INCREMENT=218617 ;
...
CREATE TABLE IF NOT EXISTS `datasources` (
  ...
  KEY `is_user` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='Table with definition of databases with user data' AUTO_INCREMENT=124 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='Tabulka obsahující informaci o namapování datových sloupců na formáty z KB' AUTO_INCREMENT=2697 ;
...
CREATE TABLE IF NOT EXISTS `formats` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='Tabulka obsahující definici jednotlivých formátů' AUTO_INCREMENT=2529 ;
...
CREATE TABLE IF NOT EXISTS `intervals` (
  ...
  KEY `format_id` (`format_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci AUTO_INCREMENT=1959 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='Table with definition of databases with user data' AUTO_INCREMENT=188 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='Tabulka obsahující definici metaatributů' AUTO_INCREMENT=1458 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Table with definition of EasyMiner instances' AUTO_INCREMENT=112 ;
...
CREATE TABLE IF NOT EXISTS `preprocessings` (
  ...
  KEY `format_id` (`format_id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='Tabulka obsahující seznam preprocessingů' AUTO_INCREMENT=595 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='Tabulka obsahující nalezená asociační pravidla' AUTO_INCREMENT=1562967 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci AUTO_INCREMENT=38904 ;
...
CREATE TABLE IF NOT EXISTS `rule_sets` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='Tabulka obsahující definici jednotlivých rulesetů' AUTO_INCREMENT=76 ;
...
CREATE TABLE IF NOT EXISTS `rule_set_rule_relations` (
  ...
  KEY `rule_set_id` (`rule_set_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci AUTO_INCREMENT=206 ;
...
CREATE TABLE IF NOT EXISTS `tasks` (
  ...
  PRIMARY KEY (`task_id`),
  KEY `miner_id` (`miner_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci AUTO_INCREMENT=1950 ;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='Table with data of users' AUTO_INCREMENT=32 ;
...
CREATE TABLE IF NOT EXISTS `values` (
  ...
  KEY `format_id` (`format_id`),
  KEY `value` (`value`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci AUTO_INCREMENT=66541 ;
...
CREATE TABLE IF NOT EXISTS `values_bins` (
  ...
  KEY `format_id` (`format_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci AUTO_INCREMENT=363 ;
